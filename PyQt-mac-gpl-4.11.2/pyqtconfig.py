...
_pkg_config = {
    ...
    'pyqt_config_args':  '--use-arch=x86_64',
    ...
    'pyqt_sip_dir':      '/opt/local/Library/Frameworks/Python.framework/Versions/2.7/share/sip/PyQt4',
    ...
    'qt_archdata_dir':   '/opt/local/share/qt4',
    'qt_data_dir':       '/opt/local/share/qt4',
    'qt_dir':            '/opt/local',
    'qt_edition':        'free',
    'qt_framework':      0,
    'qt_inc_dir':        '/opt/local/include',
    'qt_lib_dir':        '/opt/local/lib',
    'qt_threaded':       1,
    'qt_version':        0x040806,
    'qt_winconfig':      'shared'
}
