...
if __name__=='__main__':
    ...
    for p in ['sn' + str(i) + '.dat' for i in range(21, 23)]:
        snlist.append(p)
        #break
        
    for q in ['sn91t' + str(i) + '.dat' for i in range(21, 23)]:
        snlist.append(q)
        #break
        
    for r in ['sn91bg' + str(i) + '.dat' for i in range(21, 23)]:
       snlist.append(r)
       #break
    ...
    plt.plot(spec.wavelength, ibsntflux)
    plt.plot(spec.wavelength, ibgaltflux)
