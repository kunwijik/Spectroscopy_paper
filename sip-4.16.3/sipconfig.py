...
_pkg_config = {
    'arch':               'x86_64',
    'default_bin_dir':    '/opt/local/Library/Frameworks/Python.framework/Versions/2.7/bin',
    'default_mod_dir':    '/opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages',
    'default_sip_dir':    '/opt/local/Library/Frameworks/Python.framework/Versions/2.7/share/sip',
    'deployment_target':  '',
    'platform':           'macx-g++',
    'py_conf_inc_dir':    '/opt/local/Library/Frameworks/Python.framework/Versions/2.7/include/python2.7',
    'py_inc_dir':         '/opt/local/Library/Frameworks/Python.framework/Versions/2.7/include/python2.7',
    'py_lib_dir':         '/opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/config',
    'py_version':         0x020708,
    'qt_framework':       0,
    'sip_bin':            '/opt/local/Library/Frameworks/Python.framework/Versions/2.7/bin/sip',
    'sip_config_args':    '-n --arch=x86_64 -s MacOSX10.9.sdk',
    'sip_inc_dir':        '/opt/local/Library/Frameworks/Python.framework/Versions/2.7/include/python2.7',
    'sip_mod_dir':        '/opt/local/Library/Frameworks/Python.framework/Versions/2.7/lib/python2.7/site-packages',
    'sip_version':        0x041003,
    'sip_version_str':    '4.16.3',
    'universal':          '/Applications/Xcode.app/Contents/Developer/Platforms/MacOSX.platform/Developer/SDKs/MacOSX10.9.sdk'
}
