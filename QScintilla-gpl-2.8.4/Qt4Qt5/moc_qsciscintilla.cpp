...
static const uint qt_meta_data_QsciScintilla[] = {
 ...
 // slots: signature, parameters, type, tag, flags
     ...
     942,  977,   56,   56, 0x0a,
     985, 1019,   56,   56, 0x0a,
    1026, 1072,   56,   56, 0x0a,
    1079, 1111,   56,   56, 0x0a,
    1118, 1019,   56,   56, 0x0a,
    1170, 1190,   56,   56, 0x0a,
    1201, 1230,   56,   56, 0x0a,
    1233, 1261,   56,   56, 0x0a,
    1270, 1302,   56,   56, 0x0a,
    1306, 1302,   56,   56, 0x0a,
    1342, 1368,   56,   56, 0x0a,
    1375, 1394,   56,   56, 0x0a,
    1400, 1417,   56,   56, 0x0a,
    1419,   45,   56,   56, 0x0a,
    1446, 1466,   56,   56, 0x0a,
    1471, 1494,   56,   56, 0x0a,
    1502, 1528,   56,   56, 0x0a,
    1540, 1562,   56,   56, 0x2a,
    1567, 1591,   56,   56, 0x0a,
    1608, 1368,   56,   56, 0x0a,
    1635, 1302,   56,   56, 0x0a,
    1679, 1302,   56,   56, 0x0a,
    1723, 1752,   56,   56, 0x0a,
    1757, 1394,   56,   56, 0x0a,
    1782, 1803,   56,   56, 0x0a,
    1809,   56,   56,   56, 0x2a,
    1820, 1302,   56,   56, 0x0a,
    1854, 1876,   56,   56, 0x0a,
    1878, 1302,   56,   56, 0x0a,
    1912, 1943,   56,   56, 0x0a,
    1955, 1984,   56,   56, 0x0a,
    1996, 2027,   56,   56, 0x0a,
    2039, 2063,   56,   56, 0x0a,
    2076, 2104,   56,   56, 0x0a,
    2113,  323,   56,   56, 0x0a,
    2131, 1417,   56,   56, 0x0a,
    2148, 2166,   56,   56, 0x0a,
    2169, 2199,   56,   56, 0x0a,
    2233, 1302,   56,   56, 0x0a,
    2269, 1302,   56,   56, 0x0a,
    2305, 2325,   56,   56, 0x0a,
    2332, 1394,   56,   56, 0x0a,
    2349,  415,   56,   56, 0x0a,
    2366, 2380,   56,   56, 0x0a,
    2383, 1466,   56,   56, 0x0a,
    2429, 1466,   56,   56, 0x0a,
    2451,   56,   56,   56, 0x0a,
    2458,  568,   56,   56, 0x0a,
    2472, 2484,   56,   56, 0x0a,
    2490,   56,   56,   56, 0x0a,
    2499, 2484,   56,   56, 0x0a,
    2512,   56,   56,   56, 0x0a,
    2522, 2534,   56,   56, 0x0a,
    2539, 2563,   56,   56, 0x08,
    2567, 2588,   56,   56, 0x08,
    2598, 2628,   56,   56, 0x08,
    2642, 2628,   56,   56, 0x08,
    2674, 2705,   56,   56, 0x08,
    2726, 2790,   56,   56, 0x08,
    2864, 2910,   56,   56, 0x08,
    2919,   56,   56,   56, 0x08,
    2944,   56,   56,   56, 0x08,
    2966,   77,   56,   56, 0x08,
    2995,   56,   56,   56, 0x08,
    3027, 3068,   56,   56, 0x08,
    3076, 3111,   56,   56, 0x08,
    3119, 3154,   56,   56, 0x08,
    3168, 3201,   56,   56, 0x08,
    3209, 3111,   56,   56, 0x08,
    3244, 3264,   56,   56, 0x08,
    3272,   56,   56,   56, 0x08,
...
static const char qt_meta_stringdata_QsciScintilla[] = {
    "QsciScintilla\0cursorPositionChanged(int,int)\0"
    "line,index\0\0copyAvailable(bool)\0yes\0"
    ...
    "margin,line,state\0modificationAttempted()\0"
    "modificationChanged(bool)\0m\0"
    "selectionChanged()\0textChanged()\0"
    "userListActivated(int,QString)\0id,string\0"
    "append(QString)\0text\0autoCompleteFromAll()\0"
    "autoCompleteFromAPIs()\0"
    "autoCompleteFromDocument()\0callTip()\0"
    "clear()\0copy()\0cut()\0ensureCursorVisible()\0"
    "ensureLineVisible(int)\0line\0foldAll(bool)\0"
    "children\0foldAll()\0foldLine(int)\0"
    "indent(int)\0insert(QString)\0"
    "insertAt(QString,int,int)\0text,line,index\0"
    "moveToMatchingBrace()\0paste()\0redo()\0"
    "removeSelectedText()\0replaceSelectedText(QString)\0"
    "resetSelectionBackgroundColor()\0"
    "resetSelectionForegroundColor()\0"
    "selectAll(bool)\0select\0selectAll()\0"
    "selectToMatchingBrace()\0"
    "setAutoCompletionCaseSensitivity(bool)\0"
    "cs\0setAutoCompletionReplaceWord(bool)\0"
    "replace\0setAutoCompletionShowSingle(bool)\0"
    "single\0setAutoCompletionSource(AutoCompletionSource)\0"
    "source\0setAutoCompletionThreshold(int)\0"
    "thresh\0setAutoCompletionUseSingle(AutoCompletionUseSingle)\0"
    "setAutoIndent(bool)\0autoindent\0"
    "setBraceMatching(BraceMatch)\0bm\0"
    "setBackspaceUnindents(bool)\0unindent\0"
    "setCaretForegroundColor(QColor)\0col\0"
    "setCaretLineBackgroundColor(QColor)\0"
    "setCaretLineVisible(bool)\0enable\0"
    "setCaretWidth(int)\0width\0setColor(QColor)\0"
    "c\0setCursorPosition(int,int)\0"
    "setEolMode(EolMode)\0mode\0"
    "setEolVisibility(bool)\0visible\0"
    "setFolding(FoldStyle,int)\0fold,margin\0"
    "setFolding(FoldStyle)\0fold\0"
    "setIndentation(int,int)\0line,indentation\0"
    "setIndentationGuides(bool)\0"
    "setIndentationGuidesBackgroundColor(QColor)\0"
    "setIndentationGuidesForegroundColor(QColor)\0"
    "setIndentationsUseTabs(bool)\0tabs\0"
    "setIndentationWidth(int)\0setLexer(QsciLexer*)\0"
    "lexer\0setLexer()\0setMarginsBackgroundColor(QColor)\0"
    "setMarginsFont(QFont)\0f\0"
    "setMarginsForegroundColor(QColor)\0"
    "setMarginLineNumbers(int,bool)\0"
    "margin,lnrs\0setMarginMarkerMask(int,int)\0"
    "margin,mask\0setMarginSensitivity(int,bool)\0"
    "margin,sens\0setMarginWidth(int,int)\0"
    "margin,width\0setMarginWidth(int,QString)\0"
    "margin,s\0setModified(bool)\0setPaper(QColor)\0"
    "setReadOnly(bool)\0ro\0setSelection(int,int,int,int)\0"
    "lineFrom,indexFrom,lineTo,indexTo\0"
    "setSelectionBackgroundColor(QColor)\0"
    "setSelectionForegroundColor(QColor)\0"
    "setTabIndents(bool)\0indent\0setTabWidth(int)\0"
    "setText(QString)\0setUtf8(bool)\0cp\0"
    "setWhitespaceVisibility(WhitespaceVisibility)\0"
    "setWrapMode(WrapMode)\0undo()\0unindent(int)\0"
    "zoomIn(int)\0range\0zoomIn()\0zoomOut(int)\0"
    "zoomOut()\0zoomTo(int)\0size\0"
    "handleCallTipClick(int)\0dir\0"
    "handleCharAdded(int)\0charadded\0"
    "handleIndicatorClick(int,int)\0"
    "pos,modifiers\0handleIndicatorRelease(int,int)\0"
    ...
    "ded\0"
    "handlePropertyChange(const char*,const char*)\0"
    "prop,val\0handleSavePointReached()\0"
    "handleSavePointLeft()\0"
    "handleSelectionChanged(bool)\0"
    "handleAutoCompletionSelection()\0"
    "handleUserListSelection(const char*,int)\0"
    "text,id\0handleStyleColorChange(QColor,int)\0"
    "c,style\0handleStyleEolFillChange(bool,int)\0"
    "eolfill,style\0handleStyleFontChange(QFont,int)\0"
    "f,style\0handleStylePaperChange(QColor,int)\0"
    "handleUpdateUI(int)\0updated\0"
    "delete_selection()\0"
};
