...
static const char qt_meta_stringdata_QsciLexerPO[] = {
    "QsciLexerPO\0setFoldComments(bool)\0"
...
const QMetaObjectExtraData QsciLexerPO::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject QsciLexerPO::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerPO,
      qt_meta_data_QsciLexerPO, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &QsciLexerPO::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerPO))
